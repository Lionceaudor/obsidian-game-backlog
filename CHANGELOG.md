...
- Added `note` frontmatter field to generated game notes (always present, `null` by default)

### Removed

- Removed `Note` input from the Add Game modal — notes are edited directly in the created note
...
### Release 1.0.6 - 2026-01-11

### Changed

- Removed localized frontmatter fields (`platform_localized`, `priority_localized`, `genres_localized`) — no longer generated by templates
